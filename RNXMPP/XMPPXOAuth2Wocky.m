...
@implementation XMPPXOAuth2Wocky
...
@implementation XMPPStream (XMPPXOAuth2Wocky)



- (BOOL)supportsXOAuth2WockyAuthentication
{
	return [self supportsAuthenticationMechanism:[XMPPXOAuth2Wocky mechanismName]];
}
...
- (BOOL)authenticateWithFirebaseToken:(NSString *)accessToken error:(NSError **)errPtr
{
	...
	dispatch_block_t block = ^{ @autoreleasepool {
		...
		if ([self supportsXOAuth2WockyAuthentication])
		{
            XMPPXOAuth2Wocky * googleAuth = [[XMPPXOAuth2Wocky alloc] initWithStream:self
